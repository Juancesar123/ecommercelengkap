                                ...
                                <table>
                                        ...
                                        @foreach ($cart as $item)
                                            <tr class="cart_item">
                                                <td class="product-name">
                                                    {{$item->product_name}} <strong class="product-quantity"> × {{$item->qty}}</strong>
                                                </td>
                                                <td class="product-total">
                                                    <span class="amount">@currency($item->total_harga)</span>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                    <tfoot>
                                        <tr class="cart-subtotal">
                                            <th>Cart Subtotal</th>
                                            <td><span class="amount">@currency($cart->sum('total_harga'))</span></td>
                                        </tr>
                                        <tr class="shipping">
                                            <th>Shipping</th>
                                            <td>
